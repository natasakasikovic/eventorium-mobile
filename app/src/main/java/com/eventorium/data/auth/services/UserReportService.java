...
public interface UserReportService {
    ...
    Call<ResponseBody> reportUser(@Body UserReportRequest report, @Path("offender-id") Long id);

    @PATCH("user-reports/{offender-id}")
    Call<ResponseBody> updateReport(@Path("offender-id") Long id, @Body UpdateReportStatusRequest request);
}
